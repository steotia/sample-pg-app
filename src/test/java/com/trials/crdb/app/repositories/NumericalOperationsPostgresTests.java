...
@ContextConfiguration(initializers = NumericalOperationsPostgresTests.DataSourceInitializer.class)
public class NumericalOperationsPostgresTests {

    @Container
    static final PostgreSQLContainer<?> postgresContainer = 
        new PostgreSQLContainer<>(DockerImageName.parse("postgres:15-alpine"))
            .withDatabaseName("test_numerical_ops")

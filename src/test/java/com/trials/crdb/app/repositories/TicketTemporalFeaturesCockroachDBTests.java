...
@ContextConfiguration(initializers = TicketTemporalFeaturesCockroachDBTests.DataSourceInitializer.class)
public class TicketTemporalFeaturesCockroachDBTests extends TimeBasedTest {

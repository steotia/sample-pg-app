...
@ContextConfiguration(initializers = CommentFeaturesCockroachDBTests.DataSourceInitializer.class)
public class CommentFeaturesCockroachDBTests extends TimeBasedTest {
